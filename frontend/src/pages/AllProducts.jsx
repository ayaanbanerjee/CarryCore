...
const CATEGORIES = [
  "Laptops", "Tablets", "Electronics", "Phone", "Clothing", "Books",
  "Home & Kitchen", "Beauty", "Sports", "Toys", "Automotive", "Grocery",
  "Health", "Movies & Music", "Games", "Office Products", "Software",
  "Baby", "Industrial", "Jewelry", "Pet Supplies", "Luggage", "Luxury",
  "Food", "Drinks", "Furniture", "Tools", "Hardware", "Garden",
  "Outdoors", "Computers", "Watch", "Shoes", "Bag", "Hat", "Sunglasses",
  "Scarf", "Gloves",
];
...
export default function AllProducts() {
  ...
  const buyNow = (product) => {
    ...
    navigate("/checkout-address", {
      state: { source: "buyNow", productId: product._id, quantity: 1 },
    });
  };
